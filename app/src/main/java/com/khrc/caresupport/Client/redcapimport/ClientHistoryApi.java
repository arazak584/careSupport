...
public class ClientHistoryApi {
    ...
    public ClientHistoryApi(Context context) {
        // Initialize the Room database and DAO
        appDatabase = AppDatabase.getDatabase(context);
        dao = appDatabase.medHistoryDao();  // Assuming the DAO method is named profileDao()
    }

    public void loadAndInsertHistoryData(String phoneNumber, HistoryApiCallback callback, Context context) {
    ...
    private class LoadAndInsertDataTask extends AsyncTask<Void, Void, List<JsonHistory>> {
        ...
        public LoadAndInsertDataTask(HistoryApiCallback callback, Context context, String phoneNumber) {
