...
public class PregnancyApi {
    ...
    public PregnancyApi(Context context) {
        // Initialize the Room database and DAO
        appDatabase = AppDatabase.getDatabase(context);
        dao = appDatabase.pregnancyDao();  // Assuming the DAO method is named profileDao()
    }

    public void loadAndInsertPregnancyData(PregnancyApiCallback callback, Context context) {
    ...
    private class LoadAndInsertDataTask extends AsyncTask<Void, Void, List<JsonPregnancy>> {
        ...
        public LoadAndInsertDataTask(PregnancyApiCallback callback, Context context) {
